Vue.component('cart', {
    data(){
        return {      
             cartItems: [],
            cartUrl: 'productCardOfCart.json',
            showCart: false
        }
    },
    mounted(){
    ...
    template:  `<div>
    <button class="header-cart" type="button" @click="showCart = !showCart"><svg width="32" height="29" viewBox="0 0 32 29"
...
Vue.component('cart-item', {
    ...
    <div class="product-bio">
        <img :src="cartItem.img" alt="good" width="50" >
