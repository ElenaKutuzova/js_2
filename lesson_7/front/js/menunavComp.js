Vue.component ('menunavigator', {
    template: `
    <nav class="main-nav main-nav ">
    <div class="main-nav-box">
    <button class="main-nav-close"><svg width="13" height="13" viewBox="0 0 13 13" xmlns="http://www.w3.org/2000/svg">
    ...
    <ul class="main-nav-list">
        <li class="main-nav-item"><a href="catalog.html" class="main-nav-link">man</a>
            <ul class="submenu">
        ...
        <li class="main-nav-item"><a href="catalog.html" class="main-nav-link">woman</a>
            <ul class="submenu">
                <li class="submenu-item"><a href="product.html" class="submenu-link">Accessories</a></li>
        ...
        <li class="main-nav-item"><a href="catalog.html" class="main-nav-link">kids</a>
            <ul class="submenu">
                <li class="submenu-item"><a href="product.html" class="submenu-link">Accessories</a></li>
                <li class="submenu-item"><a href="product.html" class="submenu-link">Jackets & Coats</a></li>
                <li class="submenu-item"><a href="product.html" class="submenu-link">Polos</a></li>
