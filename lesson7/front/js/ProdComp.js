Vue.component('products', {
    data(){
     ...
     <product v-for="product of filtered" 
      :product="item"
      @add-product="$root.$refs.cart.addProduct(product)"></product>
     </ul>
     `
    });
    ...
    template:
       `
        ...
        <button class="products-overlay__btn-add "  @click="$emit('add-product', product)">
